...
#'
#' @param draw_number Default is draw_numbers=10 - the maximum draws in multi multi game, and the possible values of draw_numbers are integers from range 1-10 like in the real game.
#'
#' @export
